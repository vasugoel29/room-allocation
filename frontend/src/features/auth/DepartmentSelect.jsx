...
function DepartmentSelect({ 
  ...
  const displayVal = isDeptOpen ? search : (selectedDept ? selectedDept.name : '');
            ...
            {departments
              ...
              .map((d, i) => (
                <div
                  ...
                  className={`p-3 cursor-pointer border-b border-border last:border-0 transition-colors flex items-center gap-2 hover:bg-accent/5 ${departmentId === d.id ? 'bg-accent/10 font-bold border-l-4 border-l-accent' : 'font-medium'}`}
                >
