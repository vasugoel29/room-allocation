      ...
      <div className="relative">
        <div className="relative cursor-pointer" onClick={() => setIsTypeOpen(!isTypeOpen)}>
          <input
            ...
            className="w-full bg-surface-lowest dark:bg-surface-high border border-black/10 dark:border-white/10 rounded-2xl px-5 py-4 text-sm font-bold text-text-primary focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all pr-12 shadow-sm cursor-pointer font-body pointer-events-none"
          />
