...
import { Filter, Wind, Monitor, Search, Layers, Check } from 'lucide-react';
...
function RoomFilter() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        <h3 className="text-[10px] font-black text-text-secondary uppercase tracking-[0.2em] mb-6 flex items-center gap-3 opacity-50">
          <Filter size={14} />
          Discovery
        </h3>
