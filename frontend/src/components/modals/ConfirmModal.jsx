      ...
      >
        <div className="p-8 pb-4 flex justify-between items-center bg-tonal-secondary/5 font-display">
          <div className="flex items-center gap-4">
            ...
            <h2 id="confirm-modal-title" className="text-xl font-extrabold text-text-primary tracking-tight capitalize">{title}</h2>
          </div>
        ...
        <div className="p-8 pt-4 space-y-8">
          <p className="text-sm font-bold text-text-secondary leading-relaxed capitalize tracking-wider opacity-60 font-display">
            {message}
          </p>
          <div className="flex gap-4 font-display">
            <button
              onClick={onClose}
              className="flex-1 px-4 py-4 bg-tonal-secondary/10 rounded-2xl font-extrabold text-[10px] capitalize tracking-widest text-text-primary hover:bg-tonal-secondary/20 transition-all active:scale-95"
            >
              Cancel
            </button>
            <button
              ...
              className={`flex-[1.5] px-4 py-4 text-white rounded-2xl font-extrabold text-[10px] capitalize tracking-widest shadow-ambient transition-all active:scale-95 ${
