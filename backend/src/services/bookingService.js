...
async function createBooking(client, reqData, userId) {
  const { room_id, start_time, end_time, purpose } = reqData;
  ...
  const query = 'INSERT INTO bookings (room_id, start_time, end_time, created_by, purpose) VALUES ($1, $2, $3, $4, $5) RETURNING *';
  const values = [room_id, start_time, end_time, userId, purpose];
